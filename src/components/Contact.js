  ...
  return (
    <div>
      <section style={{ margin: "100px",marginTop:"10px" }}>
        ...
        <br />
        <br />
        <a href="https://github.com/DevanshiVashisht" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
        ...
        <br />
        <br />
        <a href="https://www.linkedin.com/in/devanshi-vashisht-10a931221/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
          <div style={{ display: "flex", alignItems: "center", width: "255px", height:"75px" }}>
